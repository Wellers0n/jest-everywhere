...
```ts title="E2E test" subtitle="signin-e2e.spec.ts"
import { Test, TestingModule } from "@nestjs/testing";
...
```ts 9:24 title="Init application"
import { Test, TestingModule } from "@nestjs/testing";
import { INestApplication, ValidationPipe } from "@nestjs/common";
import * as request from "supertest";
import { AppModule } from "../../../app.module";
...
- [What to test in the frontend](https://dev.to/woovi/what-to-test-in-the-frontend-50a)
- [What to test in the backend](https://dev.to/woovi/what-to-test-in-the-backend--1l44)
